...
## Task 1: Add Task
- **Scenario**: Add new project 'Assignment 1'
- **Action**: Add Task with title 'Assignment 1'
...
## Task 2: Delete Task
- **Scenario**: Remove completed task 'Assignment 1'
- **Action**: Delete Task 'Assignment 1'
- **Success**: Task removed from list, no errors
- **Target**: <5 seconds
- **Linked to**: Week 6 Job Story #6

---
## Task 3: Add 3 tasks as part of one tag
- **Scenario**: Add 3 tasks that all belong to the same tag 'programming'
- **Action**: Add Task with title 'Task 1', then 'Task 2', then 'Task 3', all under the tag 'programming'
- **Success**: All 3 tasks appear in list
- **Target**: <20 seconds
- **Linked to**: Week 6 Job Story #2

## Task 4: Find all tasks from tag 'programming'
- **Scenario**: Add 3 tasks that all belong to the same tag 'programming'
- **Action**: Add Tasks with titles 'Task 1','Task 2','Task 3', all under the tag 'programming'
- **Success**: All 3 tasks appear in the list
- **Target**: <30 seconds
- **Linked to**: Week 6 Job Story #2

## Task 5: Add a task in a bright environment
- **Scenario**: Add 3 tasks while screen visibility is limited
- **Action**: Add Task with title 'Task 1'
- **Success**: Task appears in list, no errors
- **Target**: <10 seconds
- **Linked to**: Week 6 Job Story #1 #5
...
| [Your finding 2] | [Link to metrics.csv line OR pilot notes] | Slight delay after adding task [11 secs] | [WCAG criterion] | [1-5] | [1-5] | [1-5] | [Score] |
| [Your finding 3] | |                                          | | | | | |
| [Your finding 4] | |                                          | | | | | |
| [Your finding 5] | |                                          | | | | | |
